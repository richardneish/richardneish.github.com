...
function context_message_headers_bottom($tools) {
    ...
    $data = '<tr><td colspan="3" id="context_row" style="padding-left: 20px;"><div style="display: none;" id="context_store"></div>';
    foreach ($context_btn as $index => $btn) {
        $data .= '<input type="submit" onmousedown="context_search('.$index.')" id="'.$btn['id'].'" name="'.$btn['id'].
