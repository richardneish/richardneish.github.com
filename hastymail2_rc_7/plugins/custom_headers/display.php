...
function custom_headers_compose_options($tools) {
    ...
    if ($enabled) {
        $data = '<tr><td class="aleft">Custom Header</td>
                <td style="white-space: nowrap; font-size: 90%; vertical-align: bottom;" colspan="2">
                <input type="text" name="custom_header_type" style="width: 250px;" /> 
                &#160;:&#160; <input type="text" name="custom_header_value" style="width: 250px;"/></td></tr>';
        return $data;
    }
}
function custom_headers_compose_options_table($tools) {
    $custom = $tools->get_setting('custom_header_enabled');
    $data = '<tr><td class="opt_leftcol">Show custom header options</td>
