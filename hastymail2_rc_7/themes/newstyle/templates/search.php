...
<div id="search_page"><?php echo do_display_hook('search_page_top') ?>
    <h2 id="mailbox_title2">
        ...
        <span id="mailbox_meta">
            ...
            &#160; &#160;<?php if ($pd->pd['search_total'] > 15) echo '<a href="'.$pd->sticky_url.'#search_form">Search Form</a>' ?>
        </span>
...
<!-- Message controls -->
        ...
        <form method="post" action="?page=search" >
            <div id="search_res">
                <?php echo $pd->print_search_res(array('checkbox_cell', 'from_cell', 'indicators_cell', 'subject_cell', 'date_cell'), true) ?>
            </div>
