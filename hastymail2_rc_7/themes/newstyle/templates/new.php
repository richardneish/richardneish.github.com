     ...
     <form method="post" action="?page=new" >
        <div id="new_page_controls">
            <div class="message_controls">
                ...
                <?php echo do_display_hook('new_page_controls') ?>
            </div>
...
<!-- main news page table of messages -->
        ...
        <div><div id="new_page_inner">
            <div><?php echo $pd->print_new_content(array('checkbox_cell', 'from_cell', 'indicators_cell', 'subject_cell', 'date_cell'), true) ?></div>
        </div></div>
        </div>
