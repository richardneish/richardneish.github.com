...
<!-- main menu --> 
        ...
        <div id="menu"><?php echo '
            ...
            '.do_display_hook('menu', $menu_overrides).'</complex-'.$page_id.'>
            <simple-'.$page_id.'><br />
            ...
            <?php echo '<a id="logout" href="?page=logout">'.$pd->user->str[5].'</a>' ?>
            <div id="dropdown_outer"><div id="dd_inner"><?php echo $pd->print_folder_dropdown($pd->pd['folders']) ?></div></div>
        <?php } ?>
...
<!-- close additional tags if we are showing the folder list -->
            ...
            <?php echo '<complex-'.$page_id.'>'.'<a href="'.$pd->sticky_url.'" id="show_folders" '; if (isset($_SESSION['hide_folder_list']) && $_SESSION['hide_folder_list']) {
                  echo 'style="padding-left: 40px; display: inline;" '; } echo 'onclick="hide_folder_list(); return false;">'.$pd->user->str[36].'</a></complex-'.$page_id.'>'; ?>
            <?php echo '</complex-'.$page_id.'>'; } ?>
...
<!-- page footer -->
    ...
    <div id="footer">
        ...
        &copy; Hastymail Development Group 2009
    </div>
    </body>
</html>
