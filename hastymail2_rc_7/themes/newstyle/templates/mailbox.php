...
<!-- mailbox table rows -->
                ...
                <?php echo $pd->print_mailbox_list(array('checkbox_cell', 'from_cell', 'indicators_cell', 'subject_cell', 'date_cell'), true) ?>
                </table>
            </div>
...
<!-- bottom message controls -->
                ...
                <?php if ($pd->pd['settings']['mailbox_controls_bottom']) { echo '
                    <div class="mc_inner">'.
                        $pd->print_message_controls2().do_display_hook('mailbox_controls_2').'
                    </div>'; }?>
        <?php echo '
