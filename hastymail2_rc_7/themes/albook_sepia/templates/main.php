...
<!-- main menu --> 
        ...
        <div id="menu"><?php echo '
            ...
            <a href="?page=compose&amp;mailbox='.$pd->pd['url_mailbox'].'" onclick="'.$pd->pd['compose_onclick'].'" class="'.$pd->pd['compose_link_class'].'"><img src="themes/'.$pd->pd['theme'].'/images/compose.png" title="'.$pd->user->str[3].'" alt="'.$pd->user->str[3].'" /></a>&#160;
