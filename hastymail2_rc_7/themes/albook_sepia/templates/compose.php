...
<div id="compose_page"><?php echo do_display_hook('compose_top') ?>
    <div id="mailbox_title2"><?php echo $pd->user->str[3] ?></div>
    <form enctype="multipart/form-data" method="post" action="?page=compose&amp;mailbox=<?php echo urlencode($pd->pd['mailbox']).$pd->pd['new_window_arg'] ?>">
<!-- compose form -->
