...
/* Examples of overriding plugin menu entries
$menu_overrides = array(
    'calendar_menu' => '<a href="?page=calendar"><img src="/some_image" alt="Calendar" /></a>&nbsp;',
    'filters_menu'   => '<a href="?page=filters"><img src="/some_image" alt="Filters" /></a>&nbsp;',
);
*/
...
<!-- main menu --> 
        ...
        <div id="menu"><?php echo '
            ...
            <a href="?page=compose&amp;mailbox='.$pd->pd['url_mailbox'].'" onclick="'.$pd->pd['compose_onclick'].'" class="'.$pd->pd['compose_link_class'].'">'.$pd->user->str[3].'</a>&#160;
            <a href="?page=search&amp;mailbox='.$pd->pd['url_mailbox'].'" class="'.$pd->pd['search_link_class'].'">'.$pd->user->str[9].'</a>&#160;
            <a href="?page=contacts&amp;mailbox='.$pd->pd['url_mailbox'].'" class="'.$pd->pd['contacts_link_class'].'">'.$pd->user->str[8].'</a>&#160;
            <a href="?page=options&amp;mailbox='.$pd->pd['url_mailbox'].'" class="'.$pd->pd['options_link_class'].'">'.$pd->user->str[4].'</a>&#160;
            <a href="?page=profile&amp;mailbox='.$pd->pd['url_mailbox'].'" class="'.$pd->pd['profile_link_class'].'">'.$pd->user->str[236].'</a>&#160;
            <a href="?page=folders&amp;mailbox='.$pd->pd['url_mailbox'].'" class="'.$pd->pd['folder_link_class'].'">'.$pd->user->str[7].'</a>&#160;
            '.do_display_hook('menu', $menu_overrides).'<a href="?page=logout">'.$pd->user->str[5].'</a></complex-'.$page_id.'>
            <simple-'.$page_id.'><br />
            <a href="?page=new&amp;mailbox='.$pd->pd['url_mailbox'].'" class="'.$pd->pd['new_link_class'].'">'.$pd->user->str[10].'</a>&#160;
            <a href="?page=options&amp;mailbox='.$pd->pd['url_mailbox'].'" class="'.$pd->pd['options_link_class'].'">'.$pd->user->str[4].'</a>&#160;
