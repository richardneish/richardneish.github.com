...
<!-- hastymail settings -->
        ...
        <tr><td colspan="2"><h4>Hastymail</h4></td>
            ...
            <td><?php echo $pd->user->htmlclean($pd->pd['version']) ?></td>
        </tr><tr>
...
<!-- Web server info -->
            ...
            <td><?php echo $pd->user->htmlclean($pd->pd['server']) ?></td>
        </tr><tr>
            <td class="opt_leftcol"><?php echo $pd->user->str[270] ?></td>
            <td><?php echo $pd->user->htmlclean($pd->pd['admin']) ?></td>
        </tr><tr>
            <td class="opt_leftcol"><?php echo $pd->user->str[271] ?></td>
            <td><?php echo $pd->user->htmlclean($pd->pd['host']) ?></td>
        </tr><tr>
...
<!-- IMAP server info -->
            ...
            <td class="opt_leftcol"><?php echo $pd->user->str[274] ?></td>
             <td><?php echo $pd->user->htmlclean($pd->pd['banner']) ?></td>
        </tr><tr>
            <td class="opt_leftcol"><?php echo $pd->user->str[275] ?></td>
            <td><?php echo $pd->user->htmlclean($pd->pd['caps']) ?></td>
        </tr><tr>
            <td class="opt_leftcol"><?php echo $pd->user->str[271] ?></td>
            <td><?php echo $pd->user->htmlclean($pd->pd['imap_server']) ?></td>
        </tr><tr>
...
<!-- Browser info -->
            ...
            <td><?php echo $pd->user->htmlclean($pd->pd['browser']) ?></td>
        </tr><tr>
            <td class="opt_leftcol"><?php echo $pd->user->str[278] ?></td>
            <td><?php echo $pd->user->htmlclean($pd->pd['ip']) ?></td></tr>
    </table>
