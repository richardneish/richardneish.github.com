...
function print_general_options() {
    ...
    $data .= ' /></td></tr><tr><td class="opt_leftcol">'.$this->user->str[205].'</td><td><input name="show_folder_list" type="checkbox" ';
...
function print_folder_options() {
    ...
    if (isset($vals['trash_folder']) && $vals['trash_folder']) {
        $trash_folder = $vals['trash_folder'];
    }
    if (isset($vals['sent_folder']) && $vals['sent_folder']) {
        $sent_folder = $vals['sent_folder'];
    }
    if (isset($vals['draft_folder']) && $vals['draft_folder']) {
        $draft_folder = $vals['draft_folder'];
    }
    $data = '<tr><td class="opt_leftcol">'.$this->user->str[208].'</td><td><select name="trash_folder"><option value="">'.$this->user->str[242].'</option>'.$this->print_folder_option_list(
            $this->pd['folders'], false, 0, array($trash_folder), true).'</select></td></tr><tr><td class="opt_leftcol">'.$this->user->str[209].'</td><td><select '.
            'name="sent_folder"><option value="">'.$this->user->str[242].'</option>'.$this->print_folder_option_list($this->pd['folders'], false, 0, array($sent_folder), true).'</select></td></tr>'.
            ...
            $this->pd['folders'], false, 0, array($draft_folder), true).'</select></td></tr><tr><td class="opt_leftcol">'.$this->user->str[211].'</td><td><select '.
