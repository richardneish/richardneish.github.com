...
localization['nl_NL']=	/* thanks Johan Vromans <jvromans@squirrel.nl> */
{
	_name_: 'Nederlands',
	_default_datepicker_format_: 'dd-mm-yy',
	_default_AMPM_format_: false,
...
localizationCardDAV['nl_NL']=	/* thanks Johan Vromans <jvromans@squirrel.nl> */
{
	/* index.html */
	...
	/* webdav_protocol.js */
	updateNotification: 'Er is een nieuwe versie van CardDavMATE beschikbaar: %new_ver% (u heeft nu %curr_ver%) - %url%',
